  ...
  return (
    <section id='my_gate_pass'>
      ...
      <div className='container'>
        {/* Profile Picture */}
        <div  
          style={{ backgroundImage: `url('https://res.cloudinary.com/dkrpz20px/raw/upload/v1687096624/${initialState.user?.profile?.picture[0]?.name}')` }}
        ...
        {/* QR Code */}
        <div 
          style={{ backgroundImage: `url('https://res.cloudinary.com/dkrpz20px/image/upload/v1687096624/${initialState.user?.profile?.qrCodeImage}')` }}
