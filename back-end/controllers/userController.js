...
const editProfileResident = asyncHandler(async (req, res) => {
  try {
    const { firstName,middleName,lastName,birthdate,gender,phoneNumber,address,username,type, _id } = req.body;
...
export {
  ...
  approveUser,
  fetchApplication,
  markNotificationAsRead,addWorkerAdmin,fetchWorkers,fetchWorker,updateUserFmcToken,editProfileResident
}